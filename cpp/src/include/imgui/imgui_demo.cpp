...
static void DemoWindowWidgetsTextInput() {
	...
	if (ImGui::TreeNode("Text Input")) {
		...
		if (ImGui::TreeNode("Filtered Text Input")) {
			...
			static char buf2[32] = "";
			ImGui::InputText("decimal", buf2, IM_ARRAYSIZE(buf2),
			...
			static char buf4[32] = "";
			ImGui::InputText("uppercase", buf4, IM_ARRAYSIZE(buf4),
							 ImGuiInputTextFlags_CharsUppercase);
			static char buf5[32] = "";
			ImGui::InputText("no blank", buf5, IM_ARRAYSIZE(buf5),
							 ImGuiInputTextFlags_CharsNoBlank);
			static char buf6[32] = "";
			ImGui::InputText(
				"casing swap", buf6, IM_ARRAYSIZE(buf6),
				ImGuiInputTextFlags_CallbackCharFilter,
				TextFilters::FilterCasingSwap); // Use CharFilter callback to
												// replace characters.
			static char buf7[32] = "";
			ImGui::InputText(
				"\"imgui\"", buf7, IM_ARRAYSIZE(buf7),
				ImGuiInputTextFlags_CallbackCharFilter,
		...
		if (ImGui::TreeNode("Completion, History, Edit Callbacks")) {
			...
			static char buf2[64];
			ImGui::InputText("History", buf2, IM_ARRAYSIZE(buf2),
							 ImGuiInputTextFlags_CallbackHistory,
							 Funcs::MyCallback);
			ImGui::SameLine();
			...
			ImGui::InputText("Edit", buf3, IM_ARRAYSIZE(buf3),
							 ImGuiInputTextFlags_CallbackEdit,
	...
	if (BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
		if (BeginTabItem("Sizes")) {
			...
			SliderFloat2("FramePadding", (float *)&style.FramePadding, 0.0f,
						 20.0f, "%.0f");
			SliderFloat2("ItemSpacing", (float *)&style.ItemSpacing, 0.0f,
						 20.0f, "%.0f");
			...
			SliderFloat2("CellPadding", (float *)&style.CellPadding, 0.0f,
						 20.0f, "%.0f");
...
struct ExampleAppPropertyEditor {
				...
				if (node->HasData) {
					...
					for (const ExampleMemberInfo &field_desc :
						...
						case ImGuiDataType_String: {
							ImGui::InputText(
								"##Editor", reinterpret_cast<char *>(field_ptr),
								28);
							break;
						}
						}
	...
	void DrawTreeNode(ExampleTreeNode *node) {
		...
		tree_flags |= ImGuiTreeNodeFlags_SpanFullWidth; // Span full width for
														// easier mouse reach
		tree_flags |= ImGuiTreeNodeFlags_DrawLinesToNodes; // Always draw
														   // hierarchy outlines
		if (node == VisibleNode)
